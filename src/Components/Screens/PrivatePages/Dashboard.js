      ...
      {flag ? (
        ...
        <>
          {loggedIn ? (
            <>
              <div
                className='container-fluid mt-3 authsetting'
                style={{ color: "rgb(97, 15, 89)" }}
              >
                <p>
                  Hello <strong className='text-capitalize'>{`${user}`}</strong>
                  , Welcome Back!
                </p>
                ...
                <div className='display-6'>
                  <div className='row'>
                    <div className='col-sm-12 col-md-4 col-lg-6 center-content display_graph'>
                      ...
                      <p className='pt-4 text-white'>
                        Get an visual data of how many URL's created on each
                        month
                      </p>
                    </div>
                  ...
                  <div className='row'>
                    <div className='col-sm-12 col-md-4 col-lg-6 center-content display_graph'>
                      ...
                      <p className='pt-4 text-white'>
                        Get an visual data of how many URL's created on each day
                      </p>
                    </div>
                    <div className='col-sm-12 col-md-8 col-lg-6 center-content display_image pb-3'>
                      {m_data !== undefined ? (
                        ...
                        <>
                          <h4>
                            Select appropriate Year and Month to view Data
                          </h4>
                        </>
                      )}
                    </div>
